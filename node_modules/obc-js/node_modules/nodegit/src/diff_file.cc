...
NAN_METHOD(GitDiffFile::JSNewFunction)
{
  ...
  GitDiffFile* object = new GitDiffFile(static_cast<git_diff_file *>(Local<External>::Cast(info[0])->Value()), Nan::To<bool>(info[1]).FromJust());
  object->Wrap(info.This());

  info.GetReturnValue().Set(info.This());
}

Local<v8::Value> GitDiffFile::New(void *raw, bool selfFreeing)
{
  Nan::EscapableHandleScope scope;
  Local<v8::Value> argv[2] = { Nan::New<External>((void *)raw), Nan::New(selfFreeing) };
  return scope.Escape(Nan::NewInstance(Nan::New(GitDiffFile::constructor_template), 2, argv).ToLocalChecked());
}
