...
NAN_METHOD(GitPatch::JSNewFunction)
{
  ...
  GitPatch* object = new GitPatch(static_cast<git_patch *>(Local<External>::Cast(info[0])->Value()), Nan::To<bool>(info[1]).FromJust());
  object->Wrap(info.This());

  info.GetReturnValue().Set(info.This());
}

Local<v8::Value> GitPatch::New(void *raw, bool selfFreeing)
{
  Nan::EscapableHandleScope scope;
  Local<v8::Value> argv[2] = { Nan::New<External>((void *)raw), Nan::New(selfFreeing) };
  return scope.Escape(Nan::NewInstance(Nan::New(GitPatch::constructor_template), 2, argv).ToLocalChecked());
}
...
void GitPatch::FromBlobAndBufferWorker::Execute()
{
  ...
  {
    LockMaster lockMaster(true        ,baton->old_blob
                          ,baton->old_as_path
                          ,baton->buffer
...
NAN_METHOD(GitPatch::GetDelta)
{
  ...
  {
    LockMaster lockMaster(true        ,    Nan::ObjectWrap::Unwrap<GitPatch>(info.This())->GetValue()
                         );
...
void GitPatch::GetHunkWorker::Execute()
{
  ...
  {
    LockMaster lockMaster(true        ,baton->lines_in_hunk
                          ,baton->patch
                         );
...
// start convert_to_v8 block
    ...
    if (baton->out != NULL) {
      ...
      to = GitDiffHunk::New((void *)baton->out, false);
    } else {
      to = Nan::Null();
    }
...
void GitPatch::GetLineInHunkWorker::Execute()
{
  ...
  {
    LockMaster lockMaster(true        ,baton->patch
                         );
...
// start convert_to_v8 block
    ...
    if (baton->out != NULL) {
      ...
      to = GitDiffLine::New((void *)baton->out, false);
    } else {
      to = Nan::Null();
    }
