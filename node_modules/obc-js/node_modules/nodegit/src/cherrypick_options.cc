...
void GitCherrypickOptions::InitializeComponent(Local<v8::Object> target)
{
...
NAN_METHOD(GitCherrypickOptions::JSNewFunction)
{
  ...
  if (info.Length() == 0 || !info[0]->IsExternal()) {
    ...
    instance = new GitCherrypickOptions(static_cast<git_cherrypick_options*>(Local<External>::Cast(info[0])->Value()), Nan::To<bool>(info[1]).FromJust());
  }
...
Local<v8::Value> GitCherrypickOptions::New(void* raw, bool selfFreeing)
{
  Nan::EscapableHandleScope scope;

  Local<v8::Value> argv[2] = { Nan::New<External>((void *)raw), Nan::New<Boolean>(selfFreeing) };
  return scope.Escape(Nan::NewInstance(Nan::New(GitCherrypickOptions::constructor_template), 2, argv).ToLocalChecked());
}
...
Nan::Persistent<Function> GitCherrypickOptions::constructor_template;
